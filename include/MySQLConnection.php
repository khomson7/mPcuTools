...
class MySQLConnection {
    ...
    public function checklogin1($username, $password){
      ...
      $result = mysqli_query($this->conn,"SELECT *,loginname as username FROM opduser WHERE loginname='$username' AND passweb='$enpassword'");
    ...
    public function execute($sql) {
      $result = mysqli_execute_query($this->conn, $sql); 
      return $result;
  }
    ...
    public function insertFromSelectAll($table1, $table2, $where, $columns)
    {
        $sql = "INSERT INTO $table1  SELECT $columns FROM $table2 WHERE $where";
    ...
    public function updateTable($table1, $setValues, $where) {
    
       
      $sql = "UPDATE $table1 SET $setValues WHERE $where";
      if ($this->conn->query($sql) === TRUE) {
        echo "ok";
      } else {
        echo "Error creating table: " . $this->conn->error;
    ...
    public function truncateTable($tableName) {
      ...
      if ($this->conn->query($sql) === TRUE) {
        ...
        echo "Error TRUNCATE table: " . $this->conn->error;
      }
